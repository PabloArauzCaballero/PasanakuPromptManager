# Daily de Pablo — turno día — 2026-09-20
...
- **Tu encargo:** [Grupos: el cupo como posición económica, el sorteo que cualquiera puede recomputar y el calendario que no miente](Dia1-Grupos.Servicio/CupoSorteoVerificableYCalendario.md)
...
- [ ] Skills cargadas: `rosca-group-lifecycle` · `contribution-calendar` · `state-machines-workflows` · `concurrency-and-locking` · `audit-trail-history` · `microservices-architecture` · `terminology-value-sets`
...
|---|---:|---:|---|
| **H1** — El cupo es la posición económica, no la persona | 6 | 0 | `TODO` |
| **H2** — Sorteo verificable: commit, reveal y recomputo | 6 | 0 | `TODO` |
| **H3** — Calendario determinista y vencimientos que no se equivocan de día | 6 | 0 | `TODO` |
| **TOTAL** | **18** | **0** | **0 / 18 = 0 %** |
...
|---|---|---|---|
| Q-P1 | Si falta plata para la entrega de un periodo, ¿cubre el fondo, se prorratea o se posterga? | **Negocio** — `DECISION_REQUIRED` | `ABIERTA` |
| Q-P2 | ¿El quórum para aprobar una permuta sale del reglamento o hay un mínimo de plataforma? | Negocio | `ABIERTA` |
