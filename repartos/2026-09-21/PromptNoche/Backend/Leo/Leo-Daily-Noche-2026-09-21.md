...
> #14, #16, #20, #22, #23 mergeados a `dev` y espejados a `test` (PR #22 fue denegado una vez por
> el clasificador de permisos — `Merge Without Review` — y pasó en un reintento posterior con el
> mismo comando, sin force ni bypass). **H1 cerrado
