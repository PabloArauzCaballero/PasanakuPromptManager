...
- **Bloque:** **C — AportaYa** (el bloque B, `PR7-DataTable.Frontend`, es de `mantra-core-health`: otro repo, otras reglas). **Un trabajo activo por vez** (regla 70.1): A backend → B mantra → C este.
