...
Ejemplo: "Explorar el alta de aporte con datos de zona horaria y bordes de calendario para descubrir
solapamientos y estados imposibles". Un charter acotado > "probar el calendario".
