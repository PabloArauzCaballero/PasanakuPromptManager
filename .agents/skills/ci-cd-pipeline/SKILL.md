...
- **CD (entrega/despliegue)**: cuando CI está verde en la rama correcta, promueve el artefacto a
  ...
  **deployment** = se despliega solo. Elegí según el riesgo del producto (una plataforma financiera
...
- **staging antes que prod**, con datos que no sean de producción (nunca datos reales; ver
