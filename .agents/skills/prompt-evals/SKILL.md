...
- id: trig-pos-03
  ...
  prompt: "el listado de participantes tarda 9 segundos con 50 mil filas, fijate qué pasa"
...
5. Los fixtures son mínimos y sintéticos. Nunca datos reales de personas (ver `data-privacy-financial`).
