...
- Datos financieros/datos sensibles en reposo: **cifrados** (ver §5). No los dejes en claro en el dispositivo.
...
- Datos de participantes en la base local deben estar cifrados (SQLCipher con drift/sqflite, o cifrado a
...
- Minimizá lo que se guarda offline: solo lo necesario para el flujo, con retención acotada; purgá al
  cerrar sesión. Ver `data-privacy-financial`.
...
- [ ] datos sensibles local cifrada, minimizada y purgada al cerrar sesión.
