...
|---|---|---|---|
| **Catálogo oficial** | Organismo o estándar externo | Solo una nueva versión de la fuente | División administrativa, códigos de moneda, catálogos financieros |
| **Catálogo interno** | Decisión de la casa | Un cambio revisado en el repo | Estados de un flujo, tipos de notificación |
| **Dato aportado por usuario** | La aplicación en runtime | El usuario | Una financiera que se registra |
...
3. **Prohibido** presentar como real un dato ficticio o inferido: universidades, bancos,
...
4. **Datos financieros** (entregas, dosis, contraindicaciones, interacciones, relaciones
   título → especialidad): jamás se completan ni se "corrigen" por inferencia. Exigen dataset
   con evidencia y validación del responsable de cumplimiento. Ver `money-movement-safety`.
...
- Los datos de demo son sintéticos e inequívocamente falsos. Nunca copies datos reales de
  personas a un entorno de desarrollo: `data-privacy-financial`.
