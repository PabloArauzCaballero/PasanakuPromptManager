...
Los repos de la casa contienen código que maneja datos financieros. Un repo mal configurado filtra
...
pipeline en `github-actions-ci` §5, la de los datos en `data-privacy-financial`.
...
5. Un secreto **no** es solo una API key: connection strings, claves privadas, tokens de sesión,
   dumps de base y capturas con datos de participantes también son fuga.
...
- Si el incidente pudo exponer datos personales o financieros: escalar al responsable legal y de
