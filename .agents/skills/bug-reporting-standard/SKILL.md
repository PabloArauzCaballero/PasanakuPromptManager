...
- Log recortado a lo relevante, trace de Playwright, captura, `request id`, código y cuerpo de la
  respuesta de red.
- **Nunca** pegues datos sensibles/PII real ni secretos/tokens en el reporte — enmascarálos. Ver `data-privacy-financial`.
...
- [ ] Esperado vs actual separados; criterio violado aportedo si existe.
