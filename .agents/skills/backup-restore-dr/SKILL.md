...
tiempo y los datos verificaron". En un sistema con datos financieros y contables, perderlos o no
...
- **Cifrado** en tránsito y en reposo. Un backup contiene toda la datos sensibles/PII del sistema sin los
  controles de acceso de la aplicación: es el activo más sensible que tenés (`data-privacy-financial`).
