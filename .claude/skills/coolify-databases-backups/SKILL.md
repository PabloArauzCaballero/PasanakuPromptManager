...
Complementa a `backup-restore-dr` (RPO/RTO, estrategia general) y `data-privacy-financial` (qué datos
...
documentos, contactos, notas del expediente, adjuntos. Opciones en orden de preferencia: seeds
sintéticos (`seed-data-catalogs`, `test-data-management`); dump anonimizado por script
versionado y revisado; subconjunto sin tablas de dinero. Ver `data-privacy-financial`.
