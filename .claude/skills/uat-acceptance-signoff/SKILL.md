...
- Entorno estable (staging) con datos realistas y **sintéticos** (nunca datos reales de participantes;
  ver `data-privacy-financial`, `synthetic-test-data-generation`).
...
- Incluí roles reales: quién hace qué (organizador, administrativo, participante) y qué debería o no poder.
...
- **Aprobador**: quien tiene autoridad para aceptar (dueño de producto / responsable funcional; en
  temas de dinero, el responsable de cumplimiento). Definí quién es antes de empezar.
...
- [ ] Aprobador definido y con autoridad (financiero si aplica).
