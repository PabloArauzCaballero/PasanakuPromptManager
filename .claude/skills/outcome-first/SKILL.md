...
```text
RESULTADO
Actor:          <rol concreto: participante, organizador, admin de la organización, job nocturno>
...
| Un buen criterio es | ❌ | ✅ |
|---|---|---|
| Observable desde afuera | "El servicio maneja bien los solapamientos" | "Crear un turno que pisa otro devuelve 409 y el calendario no cambia" |
...
| Centrado en el actor | "Se agrega la columna `status`" | "El organizador ve la solicitud como *Rechazada* tras recargar" |
...
ajustes orientados a mejorar el flujo de aportes..."

✅ "El organizador ya puede bloquear un rango de calendario y el bloqueo persiste tras recargar
