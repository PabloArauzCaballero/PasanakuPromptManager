...
2. **Seguridad** — autorización a nivel de objeto y de función, validación en servidor, PII financiera
...
- [ ] Seguridad: autz por objeto y función, validación servidor, PII financiera fuera de logs/respuesta.
