...
"Módulos sensibles" en un producto financiero: datos financieros, consentimiento, autenticación,
autorización, contabilidad, esquema de datos, workflows de CI. Ver `data-privacy-financial`.
...
# Por área
/src/modules/financial/      @mi-org/clinico @mi-org/seguridad
