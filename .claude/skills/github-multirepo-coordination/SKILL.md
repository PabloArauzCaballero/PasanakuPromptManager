...
- **Una rama con el mismo nombre en todos los repos afectados** (`feat/calendario-bloqueos`). Es lo
...
- modelo: org/dinero-model#84   ← este PR
- api:    org/dinero-api#312
- web:    org/dinero-web#198
Bloqueado por: org/dinero-model#84
```
