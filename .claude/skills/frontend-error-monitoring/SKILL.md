...
- **No mandes datos sensibles ni datos personales**: no incluyas el body de la respuesta, valores de
  formularios con datos de participantes, tokens ni la URL con parámetros sensibles. Scrubbeá
  antes de enviar (ver `data-privacy-financial`). Esto aplica también a la herramienta de terceros:
