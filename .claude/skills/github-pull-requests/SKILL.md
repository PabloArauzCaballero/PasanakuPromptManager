...
❌ `Cambios calendario` · `fix` · `WIP`
✅ `fix(calendario): rechazar bloqueos que se solapan con turnos confirmados`
...
- Resuelve el hilo **quien lo abrió** (o quien aplicó el cambio, aportendo el commit). No resuelvas
