...
- JWT no es "más seguro" que una sesión: es **sin estado**, y por eso no se puede revocar
  ...
  inmediato —en fintech lo necesitás—, asumí ese estado desde el diseño.
...
- El payload es legible por cualquiera: sin PII ni datos financieros, solo identificadores.
...
- Desactivar MFA con solo la contraseña. SMS como único segundo factor en datos financieros.
