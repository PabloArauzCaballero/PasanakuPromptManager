...
Reglas del smoke:
- Usuario de smoke **dedicado**, con permisos mínimos, en datos de prueba; nunca un participante real.
...
- Smoke con usuario admin real o sobre datos de participantes.
