...
datos incorrectos o una posible exposición de datos. En una plataforma financiera, la sospecha de
acceso indebido a datos de participantes es un incidente de máxima prioridad. El objetivo en caliente
...
| **SEV3** | Impacto acotado, con workaround | Se calendario, no despierta a nadie |
...
- Si hubo o pudo haber exposición de datos personales/financieros, seguí el proceso de notificación de
