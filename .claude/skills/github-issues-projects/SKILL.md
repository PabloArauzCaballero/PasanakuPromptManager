...
body:
  - type: markdown
    attributes:
      value: "No pegues datos reales de participantes ni credenciales."
  - type: textarea
    id: repro
    attributes:
...
- Aviso de privacidad arriba de todo form: nunca datos financieros ni personales reales
...
| `area:` | grupos, pagos, contable, auth, infra | Dónde pega; alinea con CODEOWNERS |
...
- Issue "Arreglar el calendario" sin criterio de aceptación.
